...
error FundMe__NotOwner(); // Hint: Nice convention for naming your errors is to add the name of the contract and __, This will help to easily know the contract where the error is coming from. This is a nice convention for error handling and troubleshooting.
...
contract FundMe {
    ...
    //Hint: Constant and immutable variables don't take up storage slot, ie they are not stored in storage, because they are part of the bytecode. They also help in gas optimization.
    ...
    // Reading from storage everytime while going through the loop cost gas. here we want to optimize and read from storage once, this helps to save gas.
