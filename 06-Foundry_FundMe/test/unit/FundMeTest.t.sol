...
contract FundMeTest is Test {
    // declaring fundMe as a state variable. This allows us to use it in various places
    FundMe fundMe;
    ...
    function setUp() external {
        ...
        // Deploying the contract... Hint: The run() is defined in the DeployFundMe.s.sol script and run returns the deployed FundMe Contract.

        /**
         * Hint: deal is a foundry CheatCode, it Sets the balance of an address "who" to "newBalance"., ie it sends it some fake money...
         *
    ...
    function testMinimumDollarIsFive() public {
        assertEq(fundMe.MINIMUM_USD(), 5e18); //$5
    }
    ...
    function testWithdrawFromMultipleFunders() public funded {
        ...
        /**
         * hoax(), Sets up a prank from an address that has some ether. If the balance is not specified, it will be set to 2^128 wei.
         * 
